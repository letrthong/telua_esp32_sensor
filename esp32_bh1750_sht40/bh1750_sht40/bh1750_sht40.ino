...
bool sendReport(bool hasReport) {
  ...
  if(hasGPIo == true){
    serverPath = serverName + "?sensorName=SHT40_BH1750_Controller&temperature=" + temperature + "&humidity=" + relative_humidity   +  "&lux=" + lux+  "&deviceID=" + deviceID + "&serialNumber=" + serialNumber;
  }
  ...
  if (hasError == true) {
      ...
      if(hasGPIo == true){
          serverPath = error_url + "?sensorName=SHT40_BH1750_Controller&deviceID=" + deviceID + "&serialNumber=" + serialNumber;
     }
  }
